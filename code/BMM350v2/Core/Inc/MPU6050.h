...
// Onderstaande 4 prototypes: uit DshotFCMetMPU6050/Core/Inc/MPU6050.h
void MPU6050_Init(void);
void MPU6050_Read_Gyro(float *gx, float *gy, float *gz);
void MPU6050_Read_Accel(float *ax, float *ay, float *az);

// Middelt 'samples' gyro-metingen terwijl de plaat STIL ligt en slaat de
// offset op. Roep dit 1x aan na MPU6050_Init(), voor de main-loop.
