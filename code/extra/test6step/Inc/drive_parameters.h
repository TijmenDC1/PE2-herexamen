...
/****** Bemf Observer ****/
#define M1_BEMF_SAMPLING_TIME              LL_ADC_SAMPLING_CYCLE(19)
...
#define SPEED_THRESHOLD_DEMAG              ((uint32_t)50000) /*!< Speed threshold above which the  RUN_DEMAGN_DELAY_MIN is applied */
...
#define PID_SPEED_KP_DEFAULT               177/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT               22/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
